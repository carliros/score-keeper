...
var _carliros$score_keeper$Scorekeeper$pointTotal = function (model) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-md-11 text-right')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _carliros$score_keeper$Scorekeeper$playerListHeader = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('panel-heading row')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('col-md-11')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _carliros$score_keeper$Scorekeeper$playListHeader = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('panel-heading row')
...
var _carliros$score_keeper$Scorekeeper$changeNamePlays = F3(
	function (nm, id, play) {
		return _elm_lang$core$Native_Utils.eq(play.id, id) ? _elm_lang$core$Native_Utils.update(
			play,
			{name: nm}) : play;
	});
var _carliros$score_keeper$Scorekeeper$changeNamePlayers = F3(
	function (nm, id, player) {
		return _elm_lang$core$Native_Utils.eq(player.id, id) ? _elm_lang$core$Native_Utils.update(
			player,
			{name: nm}) : player;
	});
var _carliros$score_keeper$Scorekeeper$edit = F2(
	function (model, id) {
		var newPlays = A2(
			_elm_lang$core$List$map,
			A2(_carliros$score_keeper$Scorekeeper$changeNamePlays, model.name, id),
			model.plays);
		var newPlayers = A2(
			_elm_lang$core$List$map,
			A2(_carliros$score_keeper$Scorekeeper$changeNamePlayers, model.name, id),
			model.players);
		return _elm_lang$core$Native_Utils.update(
			model,
			{players: newPlayers, plays: newPlays});
	});
var _carliros$score_keeper$Scorekeeper$select = F2(
	function (model, player) {
		var newPlayers = A2(
			_elm_lang$core$List$map,
			function (p) {
				return _elm_lang$core$Native_Utils.eq(p.id, player.id) ? _elm_lang$core$Native_Utils.update(
					p,
					{isEdit: true}) : p;
			},
			model.players);
		return _elm_lang$core$Native_Utils.update(
			...
			{
				name: player.name,
				playerId: _elm_lang$core$Maybe$Just(player.id),
				players: newPlayers
			});
	});
var _carliros$score_keeper$Scorekeeper$deletePlay = F2(
	function (model, play) {
		var newPlayers = A2(
			_elm_lang$core$List$map,
			function (player) {
...
var _carliros$score_keeper$Scorekeeper$cancel = function (model) {
	var newPlayers = A2(
		_elm_lang$core$List$map,
		function (p) {
			return _elm_lang$core$Native_Utils.update(
	...
	return _elm_lang$core$Native_Utils.update(
		model,
		{name: '', playerId: _elm_lang$core$Maybe$Nothing, players: newPlayers});
};
var _carliros$score_keeper$Scorekeeper$initModel = {
...
var _carliros$score_keeper$Scorekeeper$Model = F4(
	function (a, b, c, d) {
		return {players: a, name: b, playerId: c, plays: d};
	});
var _carliros$score_keeper$Scorekeeper$Player = F4(
	function (a, b, c, d) {
		return {id: a, name: b, points: c, isEdit: d};
	});
var _carliros$score_keeper$Scorekeeper$add = function (model) {
	var player = A4(
		_carliros$score_keeper$Scorekeeper$Player,
...
var _carliros$score_keeper$Scorekeeper$save = function (model) {
	var _p0 = model.playerId;
	if (_p0.ctor === 'Just') {
		return A2(_carliros$score_keeper$Scorekeeper$edit, model, _p0._0);
	} else {
		return _carliros$score_keeper$Scorekeeper$add(model);
	}
};
var _carliros$score_keeper$Scorekeeper$Play = F4(
	function (a, b, c, d) {
		return {id: a, playerId: b, name: c, points: d};
	});
var _carliros$score_keeper$Scorekeeper$score = F3(
	function (model, scorer, points) {
		var play = A4(
			_carliros$score_keeper$Scorekeeper$Play,
...
var _carliros$score_keeper$Scorekeeper$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Save':
				return _elm_lang$core$String$isEmpty(model.name) ? model : _carliros$score_keeper$Scorekeeper$save(model);
			case 'Cancel':
				return _carliros$score_keeper$Scorekeeper$cancel(model);
			case 'Input':
				return A2(
					_elm_lang$core$Debug$log,
					'Input updateded model',
					_elm_lang$core$Native_Utils.update(
						model,
						{name: _p1._0}));
			case 'Score':
				return A3(_carliros$score_keeper$Scorekeeper$score, model, _p1._0, _p1._1);
			case 'Edit':
				return A2(_carliros$score_keeper$Scorekeeper$select, model, _p1._0);
			default:
				return A2(_carliros$score_keeper$Scorekeeper$deletePlay, model, _p1._0);
		}
	});
var _carliros$score_keeper$Scorekeeper$DeletePlay = function (a) {
	return {ctor: 'DeletePlay', _0: a};
};
var _carliros$score_keeper$Scorekeeper$play = function (play) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-md-1 glyphicon glyphicon-remove'),
						_elm_lang$html$Html_Events$onClick(
						_carliros$score_keeper$Scorekeeper$DeletePlay(play))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-md-3 text-left')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
...
var _carliros$score_keeper$Scorekeeper$playList = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _carliros$score_keeper$Scorekeeper$play, model.plays));
};
var _carliros$score_keeper$Scorekeeper$playSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_carliros$score_keeper$Scorekeeper$playListHeader,
				_carliros$score_keeper$Scorekeeper$playList(model)
			]));
};
var _carliros$score_keeper$Scorekeeper$Cancel = {ctor: 'Cancel'};
var _carliros$score_keeper$Scorekeeper$Save = {ctor: 'Save'};
var _carliros$score_keeper$Scorekeeper$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _carliros$score_keeper$Scorekeeper$playerForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('form-inline'),
				_elm_lang$html$Html_Events$onSubmit(_carliros$score_keeper$Scorekeeper$Save)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onInput(_carliros$score_keeper$Scorekeeper$Input),
				...
				A3(
				_circuithub$elm_bootstrap_html$Bootstrap_Html$btnPrimary$,
				'pull-right',
				_elm_lang$core$Native_Utils.update(
					_circuithub$elm_bootstrap_html$Bootstrap_Html$btnParam,
					{
						label: _elm_lang$core$Maybe$Just('Cancel')
					}),
				_carliros$score_keeper$Scorekeeper$Cancel),
				A2(
				_circuithub$elm_bootstrap_html$Bootstrap_Html$btnSubmitPrimary$,
				'pull-right',
				_elm_lang$core$Native_Utils.update(
					_circuithub$elm_bootstrap_html$Bootstrap_Html$btnParam,
					{
						label: _elm_lang$core$Maybe$Just('Save')
					}))
			]));
};
var _carliros$score_keeper$Scorekeeper$Score = F2(
	function (a, b) {
		return {ctor: 'Score', _0: a, _1: b};
	});
var _carliros$score_keeper$Scorekeeper$Edit = function (a) {
	return {ctor: 'Edit', _0: a};
};
var _carliros$score_keeper$Scorekeeper$player = function (player) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-md-1 glyphicon glyphicon-edit'),
						_elm_lang$html$Html_Events$onClick(
						_carliros$score_keeper$Scorekeeper$Edit(player))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('button'),
								_elm_lang$html$Html_Events$onClick(
								A2(_carliros$score_keeper$Scorekeeper$Score, player, 2))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('button'),
								_elm_lang$html$Html_Events$onClick(
								A2(_carliros$score_keeper$Scorekeeper$Score, player, 3))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _carliros$score_keeper$Scorekeeper$playerList = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _carliros$score_keeper$Scorekeeper$playerSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_carliros$score_keeper$Scorekeeper$playerListHeader,
				_carliros$score_keeper$Scorekeeper$playerList(model),
				_carliros$score_keeper$Scorekeeper$pointTotal(model)
			]));
};
var _carliros$score_keeper$Scorekeeper$view = function (model) {
	return _circuithub$elm_bootstrap_html$Bootstrap_Html$container_(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_carliros$score_keeper$Scorekeeper$playerSection(model),
				_carliros$score_keeper$Scorekeeper$playerForm(model),
				_carliros$score_keeper$Scorekeeper$playSection(model)
			]));
};
var _carliros$score_keeper$Scorekeeper$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _carliros$score_keeper$Scorekeeper$initModel, view: _carliros$score_keeper$Scorekeeper$view, update: _carliros$score_keeper$Scorekeeper$update})
};

var Elm = {};
Elm['Scorekeeper'] = Elm['Scorekeeper'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Scorekeeper'], 'Scorekeeper', typeof _carliros$score_keeper$Scorekeeper$main === 'undefined' ? null : _carliros$score_keeper$Scorekeeper$main);
